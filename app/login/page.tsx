...
function LoginForm() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-base px-4 sm:px-6">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                minLength={6}
                className="input-editorial w-full py-2 text-base pr-10"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute inset-y-0 right-0 px-3 flex items-center text-on-surface-muted hover:text-primary transition-colors focus:outline-none"
      ...
      <div className="w-full mt-16 mt-auto">
        <Footer />
      </div>
    </div>
  );
